...
var url;
async function getAccessTokenSelfAnnotate(token,id) {
  return $.ajax({
   url:  "https://api.box.com/oauth2/token",
    ...
    data:{
      ...
      "scope":"base_explorer",
      "resource":"https://api.box.com/2.0/files/"+id,
      "grant_type":"urn:ietf:params:oauth:grant-type:token-exchange"
    },
    success: function (response) {
      console.log("accessToken:" + response);
      sessionStorage.setItem("accessTokenAnnotate", response.userToken);
    },
